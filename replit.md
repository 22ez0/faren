...
- **Push pendente para liberar fix em prod**: o commit local com o fix do upload + remoção do `dotenv` ainda não foi pra `origin/main`. Render auto-deploy só dispara quando `main` muda no GitHub. Detalhes completos em `CHANGES-2026-04-26-upload-fix.md`.
